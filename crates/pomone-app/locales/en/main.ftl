...
# Placement + capacity curve (Epic 3, story 3.2)
nav-placement = Placement
title-placement = Placement
placement-hint = Assign planned successions to a bed and watch the occupancy curve react — sheltered and open-field apart. Overflow shows amber with the peak value.
placement-unplaced-title = To place
placement-beds-title = Beds
placement-curve-title = Soil occupancy
placement-empty-unplaced = Nothing to place. Generate successions from a plan line.
placement-empty-beds = No beds. Create locations first.
placement-col-variety = Variety
placement-col-date = Date
placement-col-bed-meters = Bed metres
placement-strata-label = Stratum
placement-plants-label = Plants
placement-place = Place
placement-unplace = Undo placement
placement-legend-open = Open field
placement-legend-covered = Sheltered
placement-composition-title = Series composing the peak
placement-composition-empty = Click the peak to see which series compose it.
placement-peak-open = Open-field peak: { $peak } / { $cap } m
placement-peak-covered = Sheltered peak: { $peak } / { $cap } m
placement-placed = Succession placed.
placement-unplaced = Placement undone — the succession returns to place.
placement-nothing-to-undo = No recent placement to undo.
placement-error-plants = Enter a valid plant count (> 0).
placement-error-strata = Choose a stratum.
placement-error-generic = Cannot place.
