...
- [ ] **Phase 1** — `pomone-domain` : modèle métier complet, tests proptest
- [ ] **Phase 2** — `pomone-db` : trait `Repository`, schéma + migrations SQLite, impl SQLite
- [ ] **Phase 3** — backend MariaDB + tests d'intégration paramétrés sur les deux backends
- [ ] **Phase 4** — `pomone-app` : services, use cases, gestion d'état
- [ ] **Phase 5** — i18n (fr + en) avec Fluent
- [ ] **Phase 6** — `pomone-ui` Slint : écrans principaux (plantations, calendrier, parcelles)
