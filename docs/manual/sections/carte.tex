...
\begin{todobox}
À venir : drag-and-drop pour déplacer une barre directement à la souris ; division en 3 parts ou plus dans un seul écran ; alertes de rotation (interdire la même famille deux saisons consécutives sur la même planche).
\end{todobox}
