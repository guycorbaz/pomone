...
\begin{tabularx}{\linewidth}{lX}
  ...
  \texttt{Ctrl+3} & Tâches \\
  \texttt{Ctrl+4} & Cultures \\
  \texttt{Ctrl+5} & Lieux \\
  \texttt{Ctrl+6} & Calendrier (récoltes) \\
  \texttt{Ctrl+7} & Strates \\
  \texttt{Ctrl+8} & Paramètres \\
  \texttt{F1} & Ouvrir ce manuel \\
  \texttt{Gauche / Droite} & Mois précédent/suivant (sur Calendrier ou Tâches) \\
